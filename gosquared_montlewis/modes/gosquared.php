...
{
	echo('<iframe src="https://www.gosquared.com/labs/_embed/?api_key='.$Settings->get('gs_api')->settingValue().'&site_token='.$Settings->get('gs_site_id')->settingValue().'&dashboard=now" width="100%" height="100%" frameborder="0"></iframe>');
};
